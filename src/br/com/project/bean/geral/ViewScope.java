...
public class ViewScope implements Scope, Serializable {
	...
	// getViewRoot = retorna o componente raiz que está associado a esta solicitação (request).
	// getViewMap = retorna um Map que atua como a interface para armazenamento de dados.
